...
- [ ] Buscadores de productos (por código, nombre, categoría, rango de precio)
- [ ] Cálculo de comisión (5% hasta 2 productos, 10% más de 2)
- [ ] Manejo de excepciones
- [ ] Diagrama Entidad-Relación

## Cómo correrlo

(Se va a completar cuando el Main esté listo)
